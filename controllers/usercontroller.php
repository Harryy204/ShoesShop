...
class UserController extends BaseController
{
    ...
    public function register()
    {
        ...
        if (isset($_POST['submit'])) {
            ...
            // $input['email'] = $email; // Cập nhật lại giá trị trong mảng $input
            ...
            //     $data['errors'] = MESSAGES['email_used'];
            //     return $this->view('user.register', $data);
            // }
            ...
            if ($user_id) {
                ...
                $avatar = Func::copyFileFromTo('images/defaults/avatar.jpg', 'images.users.avatars', $user_id);
                $cover = Func::copyFileFromTo('images/defaults/cover.png', 'images.users.covers', $user_id);
