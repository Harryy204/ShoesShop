                                        ...
                                        <form method="post" action="" class="col-lg-12 col-md-12 col-sm-12 " >
                                            <div class="row dangki">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    ...
                                                    <input name="yourname" class="form-control" type="text" placeholder="Nhập họ và tên" >
                                                </div>
                                            </div>
                                            <div class="row dangki">
                                                <div class="col-lg-6 col-md-6 col-sm-6 ">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    ...
                                                    <input name="email" class="form-control" type="email" placeholder="Nhập địa chỉ Email" >
                                                </div>
                                            </div>
                                            <div class="row dangki">
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <label for="confirmpassword">Xác nhận mật khẩu <span class="color--red">*</span></label>
                                                    <input name="confirmpassword" class="form-control" type="password" placeholder="Nhập xác nhận mật khẩu" >
                                                </div>
