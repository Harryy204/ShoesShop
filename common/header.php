                ...
                <div class="col-lg-9 col-md-9 col-6 m-auto">
                    <div class="header__info">
                        ...
                        <?php
                            ...
                            {
                                echo '
                                    <span id="dropdownUser" data-bs-toggle="dropdown" aria-expanded="false" class="text--bold color--gray cursor--pointer me-3">' . $_SESSION['fullname'] . '</span>
                ...
                <nav class="navbar navbar-expand-md navbar-dark">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo ROUTES['product'] ?>&category=5">Giày trẻ em</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo ROUTES['product'] ?>&category=6">Giày Nam</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo ROUTES['product'] ?>&category=7">Giày Nữ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo ROUTES['product'] ?>&category=8">Giày khác</a>
                            </li>
                        </ul>
